  ...
  return (
    <footer className="footer footer-horizontal footer-center rounded p-10 ">
      <nav className="grid grid-flow-col gap-4">
        <a href="#" className="link link-hover transition-colors duration-200 hover:text-[#FFD700]">
          About us
        </a>
        <a href="#" className="link link-hover transition-colors duration-200 hover:text-[#FFD700]">
          Contact
      ...
      <nav>
        <div className="grid grid-flow-col gap-4">
          <a href="#" className="transition-colors duration-200 hover:text-[#FFD700]">
            <svg
            ...
            >
              ...
              .626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 
              2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 
              0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 
              2.457-2.549z"/>
            </svg>
          </a>
          ...
          <a href="#" className="transition-colors duration-200 hover:text-[#FFD700]">
            ...
            >
              <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0
                ...
                4.385 8.816 3.6.245 11.626.246 15.23 0 
