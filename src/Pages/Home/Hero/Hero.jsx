    ...
    <section data-aos="fade-up" className="flex flex-col-reverse  md:flex-col-reverse lg:flex-row items-center justify-around min-h-[70vh] px-4 md:px-12 py-8 gap-6 md:gap-10 lg:gap-16">
      ...
      <div className=" text-center lg:text-left mt-4 lg:mt-0">
        ...
        <p className="text-lg leading-relaxed lora mt-4">
          I’m a <span className="font-semibold text-[#B63AFF]">final year B.Sc student</span> at 
          <span className="font-semibold text-[#B63AFF]"> Green University of Bangladesh</span>, aiming to become a 
          <span className="font-semibold text-[#B63AFF]"> Software Engineer</span>. I love building 
