  ...
  return (
    ...
    >
      ...
      <div className=" bg-[#1c0f2b] border border-[#B63AFF] rounded-xl shadow-lg p-6 min-h-[250px] transition flex flex-col">
        ...
        <p className="text-lg font-medium mb-1 lora">Programming Hero</p>
        <p className="text-base mb-2 lora">
          Duration: <span className="font-semibold">2025</span>
        </p>
        <p className="text-base mb-2 lora">
          Completed an intensive, project-based bootcamp covering both frontend
          and backend. Built multiple real-world web applications following
